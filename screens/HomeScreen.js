...
import { ScrollView, SafeAreaView, StatusBar, Animated, Easing, TouchableOpacity, Platform } from 'react-native'
...
class HomeScreen extends React.Component {
    ...
    handleAvatar = () => {
        if (this.props.name && this.props.name !== "Stranger") {
            this.props.openMenu()
        } else {
                    ...
                    <SafeAreaView>
                        <ScrollView style={{ height: '100%', }}>
                            ...
                            <ScrollView horizontal={true} style={{ paddingBottom: 30 }} showsHorizontalScrollIndicator={false}>
                                <Query query={cardsQuery} fetchPolicy='network-only'>
                                    {({ loading, error, data }) => {
...
const courses = [
    {
        title: "Prototype in InVision Sudio",
